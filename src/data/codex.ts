...
export const CODEX_SUMMARIES: Record<string, string> = {
  ...
  SC: "Seychelles is an archipelago of 115 islands in the Indian Ocean off East Africa, and is Africa's smallest sovereign country by both area and population. Long uninhabited, it was settled under French rule and later held by Britain before independence in 1976. Today it has the highest GDP per capita in Africa, driven by upmarket tourism and tuna fishing, and is celebrated for its biodiversity — including the giant Aldabra tortoise and the coco de mer palm, which produces the largest seed in the plant kingdom.",
  ...
  TW: "Taiwan, officially the Republic of China, is an island state off the southeast coast of mainland China. The ROC government relocated to Taiwan in 1949 after losing the Chinese Civil War, and the island has since grown into a prosperous, high-tech democracy. Its political status is disputed — the People's Republic of China claims it as a province — but it functions as a self-governing state with its own military, currency and elections. Taiwan is the world's leading producer of advanced semiconductors and is known for its night markets, dramatic mountain scenery and vibrant civil society.",
