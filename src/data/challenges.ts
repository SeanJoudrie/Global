    ...
    countries: [
      ...
      // ── South Korea (17 administrative divisions) ─────────────────────────────
      {
        ...
        subRegions: [
          ...
          { code: "kr-11", name: "Seoul",                group: "Special & Metropolitan Cities" },
          { code: "kr-21", name: "Busan",                group: "Special & Metropolitan Cities" },
          { code: "kr-22", name: "Daegu",                group: "Special & Metropolitan Cities" },
          { code: "kr-23", name: "Incheon",              group: "Special & Metropolitan Cities" },
          { code: "kr-24", name: "Gwangju",              group: "Special & Metropolitan Cities" },
          { code: "kr-25", name: "Daejeon",              group: "Special & Metropolitan Cities" },
          { code: "kr-26", name: "Ulsan",                group: "Special & Metropolitan Cities" },
          { code: "kr-50", name: "Sejong",               group: "Special & Metropolitan Cities" },
          // Provinces
          { code: "kr-41", name: "Gyeonggi",             group: "Provinces" },
          { code: "kr-42", name: "Gangwon",              group: "Provinces" },
          { code: "kr-43", name: "North Chungcheong",    group: "Provinces" },
          { code: "kr-44", name: "South Chungcheong",    group: "Provinces" },
          { code: "kr-45", name: "North Jeolla",         group: "Provinces" },
          { code: "kr-46", name: "South Jeolla",         group: "Provinces" },
          { code: "kr-47", name: "North Gyeongsang",     group: "Provinces" },
          { code: "kr-48", name: "South Gyeongsang",     group: "Provinces" },
          { code: "kr-49", name: "Jeju",                 group: "Provinces" },
        ],
      },
