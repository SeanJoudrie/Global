    ...
    countries: [
      ...
      // ── United Kingdom (England 9 regions · Scotland 32 · Wales 22 · NI 11) ──
      {
        ...
        subRegions: [
          ...
          { code: "gb-ans", name: "Angus",                        flagUrl: wiki("Flag of Angus, Scotland.svg"),    group: "Scotland" },
          { code: "gb-agb", name: "Argyll and Bute",              flagUrl: wiki("Flag of Argyll and Bute.svg"),    group: "Scotland" },
          { code: "gb-clk", name: "Clackmannanshire",             group: "Scotland" },
          { code: "gb-dgy", name: "Dumfries and Galloway",        flagUrl: wiki("Flag of Dumfries and Galloway.svg"), group: "Scotland" },
          { code: "gb-dnd", name: "Dundee City",                  flagUrl: wiki("Flag of Dundee.svg"),             group: "Scotland" },
          ...
          { code: "gb-els", name: "Na h-Eileanan Siar",           flagUrl: wiki("Flag of the Western Isles.svg"),  group: "Scotland" },
          { code: "gb-fal", name: "Falkirk",                      group: "Scotland" },
          { code: "gb-fif", name: "Fife",                         flagUrl: wiki("Flag of Fife.svg"),               group: "Scotland" },
          { code: "gb-glg", name: "Glasgow City",                 flagUrl: wiki("Flag of Glasgow.svg"),            group: "Scotland" },
          { code: "gb-hld", name: "Highland",                     flagUrl: wiki("Flag of the Highland council area.svg"), group: "Scotland" },
          { code: "gb-ivc", name: "Inverclyde",                   group: "Scotland" },
          { code: "gb-mln", name: "Midlothian",                   flagUrl: wiki("Flag of Midlothian.svg"),         group: "Scotland" },
          { code: "gb-mry", name: "Moray",                        flagUrl: wiki("Flag of Moray.svg"),              group: "Scotland" },
          ...
          { code: "gb-pkn", name: "Perth and Kinross",            flagUrl: wiki("Flag of Perth and Kinross.svg"),  group: "Scotland" },
          { code: "gb-rfw", name: "Renfrewshire",                 group: "Scotland" },
          { code: "gb-scb", name: "Scottish Borders",             flagUrl: wiki("Flag of the Scottish Borders.svg"), group: "Scotland" },
          ...
          { code: "gb-wln", name: "West Lothian",                 flagUrl: wiki("Flag of West Lothian.svg"),       group: "Scotland" },
          ...
          { code: "gb-cmn", name: "Carmarthenshire",              flagUrl: wiki("Flag of Carmarthenshire.svg"),    group: "Wales" },
          { code: "gb-cgn", name: "Ceredigion",                   flagUrl: wiki("Flag of Ceredigion.svg"),         group: "Wales" },
          { code: "gb-cwy", name: "Conwy",                        group: "Wales" },
          { code: "gb-den", name: "Denbighshire",                 flagUrl: wiki("Flag of Denbighshire.svg"),       group: "Wales" },
          ...
          { code: "gb-nwp", name: "Newport",                      flagUrl: wiki("Flag of Newport, Wales.svg"),     group: "Wales" },
          ...
          { code: "gb-swa", name: "Swansea",                      flagUrl: wiki("Flag of Swansea.svg"),            group: "Wales" },
          { code: "gb-tof", name: "Torfaen",                      group: "Wales" },
          { code: "gb-vgl", name: "Vale of Glamorgan",            group: "Wales" },
          { code: "gb-wrx", name: "Wrexham",                      flagUrl: wiki("Flag of Wrexham.svg"),            group: "Wales" },
          ...
          { code: "gb-drs", name: "Derry City & Strabane",        flagUrl: wiki("Flag of Derry.svg"),              group: "Northern Ireland" },
      ...
      // ── Serbia (25 districts + Belgrade) ────────────────────────────────
      {
        ...
        subRegions: [
          // Belgrade City
          { code: "rs-00", name: "Belgrade",           flagUrl: wiki("Flag of Belgrade, Serbia.svg") },
          // Central Serbia – 17 districts
          { code: "rs-01", name: "Braničevo" },
          { code: "rs-02", name: "Jablanica" },
          { code: "rs-03", name: "Kolubara" },
          { code: "rs-04", name: "Mačva" },
          { code: "rs-05", name: "Moravica" },
          { code: "rs-06", name: "Nišava" },
          { code: "rs-07", name: "Pčinja" },
          { code: "rs-08", name: "Pirot" },
          { code: "rs-09", name: "Podunavlje" },
          { code: "rs-10", name: "Pomoravlje" },
          { code: "rs-11", name: "Rasina" },
          { code: "rs-12", name: "Raška" },
          { code: "rs-13", name: "Toplica" },
          { code: "rs-14", name: "Zaječar" },
          { code: "rs-15", name: "Zlatibor" },
          { code: "rs-16", name: "Šumadija" },
          { code: "rs-17", name: "Bor" },
          // Vojvodina – 7 districts
          { code: "rs-19", name: "South Bačka" },
          { code: "rs-20", name: "North Bačka" },
          { code: "rs-21", name: "West Bačka" },
          { code: "rs-22", name: "North Banat" },
          { code: "rs-23", name: "Central Banat" },
          { code: "rs-24", name: "South Banat" },
          { code: "rs-25", name: "Srem" },
        ],
      },
