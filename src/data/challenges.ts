    ...
    countries: [
      ...
      // ── Ireland (26 counties) ────────────────────────────────────────────
      {
        ...
        subRegions: [
          ...
          { code: "ie-cw", name: "Carlow",    flagUrl: flag("ie-cw"), group: "Leinster" },
          { code: "ie-d",  name: "Dublin",    flagUrl: flag("ie-d"),  group: "Leinster" },
          { code: "ie-ke", name: "Kildare",   flagUrl: flag("ie-ke"), group: "Leinster" },
          { code: "ie-kk", name: "Kilkenny",  flagUrl: flag("ie-kk"), group: "Leinster" },
          { code: "ie-ls", name: "Laois",     flagUrl: flag("ie-ls"), group: "Leinster" },
          { code: "ie-ld", name: "Longford",  flagUrl: flag("ie-ld"), group: "Leinster" },
          { code: "ie-lh", name: "Louth",     flagUrl: flag("ie-lh"), group: "Leinster" },
          { code: "ie-mh", name: "Meath",     flagUrl: flag("ie-mh"), group: "Leinster" },
          { code: "ie-oy", name: "Offaly",    flagUrl: flag("ie-oy"), group: "Leinster" },
          { code: "ie-wh", name: "Westmeath", flagUrl: flag("ie-wh"), group: "Leinster" },
          { code: "ie-wx", name: "Wexford",   flagUrl: flag("ie-wx"), group: "Leinster" },
          { code: "ie-ww", name: "Wicklow",   flagUrl: flag("ie-ww"), group: "Leinster" },
          // Munster – 6 counties
          { code: "ie-ce", name: "Clare",     flagUrl: flag("ie-ce"), group: "Munster" },
          { code: "ie-co", name: "Cork",      flagUrl: flag("ie-co"), group: "Munster" },
          { code: "ie-ky", name: "Kerry",     flagUrl: flag("ie-ky"), group: "Munster" },
          { code: "ie-lk", name: "Limerick",  flagUrl: flag("ie-lk"), group: "Munster" },
          { code: "ie-ta", name: "Tipperary", flagUrl: flag("ie-ta"), group: "Munster" },
          { code: "ie-wd", name: "Waterford", flagUrl: flag("ie-wd"), group: "Munster" },
          // Connacht – 5 counties
          { code: "ie-g",  name: "Galway",    flagUrl: flag("ie-g"),  group: "Connacht" },
          { code: "ie-lm", name: "Leitrim",   flagUrl: flag("ie-lm"), group: "Connacht" },
          { code: "ie-mo", name: "Mayo",      flagUrl: flag("ie-mo"), group: "Connacht" },
          { code: "ie-rn", name: "Roscommon", flagUrl: flag("ie-rn"), group: "Connacht" },
          { code: "ie-so", name: "Sligo",     flagUrl: flag("ie-so"), group: "Connacht" },
          // Ulster (Irish counties) – 3 counties
          { code: "ie-cn", name: "Cavan",     flagUrl: flag("ie-cn"), group: "Ulster" },
          { code: "ie-dl", name: "Donegal",   flagUrl: flag("ie-dl"), group: "Ulster" },
          { code: "ie-mn", name: "Monaghan",  flagUrl: flag("ie-mn"), group: "Ulster" },
        ],
      },
