...
// flag-icons via jsDelivr — covers national flags and many ISO 3166-2 subdivisions
// (Canadian provinces, Mexican/Brazilian states, etc.). Uses the @7 range so a single
// yanked patch version can't break every flag at once. US states/territories use
// Wikimedia Commons instead (flag-icons coverage of us-* was unreliable).
const flag = (iso: string) => `https://cdn.jsdelivr.net/npm/flag-icons@7/flags/4x3/${iso.toLowerCase()}.svg`
    ...
    countries: [
      ...
      // ── Iraq (19 governorates) ───────────────────────────────────────────────
      {
        ...
        subRegions: [
          ...
          { code: "iq-ar", name: "Erbil" },
          { code: "iq-ba", name: "Basra" },
          { code: "iq-bb", name: "Babylon" },
          { code: "iq-bg", name: "Baghdad" },
          { code: "iq-da", name: "Dohuk" },
          { code: "iq-di", name: "Diyala" },
          { code: "iq-dq", name: "Dhi Qar" },
          { code: "iq-hl", name: "Halabja" },
          { code: "iq-ka", name: "Karbala" },
          { code: "iq-kr", name: "Kirkuk" },
          { code: "iq-ma", name: "Maysan" },
          { code: "iq-mu", name: "Al-Muthanna" },
          { code: "iq-na", name: "Najaf" },
          { code: "iq-ni", name: "Nineveh" },
          { code: "iq-qa", name: "Al-Qadisiyyah" },
          { code: "iq-sa", name: "Saladin" },
          { code: "iq-su", name: "Sulaymaniyah" },
