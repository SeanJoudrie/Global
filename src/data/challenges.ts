  ...
  // ── ASIA ──────────────────────────────────────────────────────────────────
  {
    ...
    countries: [
      ...
      // ── Georgia (12 first-level divisions) ───────────────────────────────────
      {
        ...
        subRegions: [
          { code: "ge-ab", name: "Abkhazia",                              group: "Autonomous Republics" },
          { code: "ge-aj", name: "Adjara",                                group: "Autonomous Republics" },
      ...
      // ── Mongolia (22 provinces + capital) ────────────────────────────────────
      {
        ...
        subRegions: [
          { code: "mn-ar", name: "Arkhangai" },
          { code: "mn-bh", name: "Bayan-Ölgii" },
          { code: "mn-bk", name: "Bayankhongor" },
          { code: "mn-bu", name: "Bulgan" },
          { code: "mn-da", name: "Darkhan-Uul" },
          { code: "mn-dg", name: "Dornogobi" },
          { code: "mn-do", name: "Dornod" },
          { code: "mn-dz", name: "Dundgovi" },
          { code: "mn-ga", name: "Govi-Altai" },
          { code: "mn-gs", name: "Govisümber" },
          { code: "mn-kh", name: "Khentii" },
          { code: "mn-kv", name: "Khövsgöl" },
          { code: "mn-kd", name: "Khovd" },
          { code: "mn-og", name: "Ömnögovi" },
          { code: "mn-or", name: "Orkhon" },
          { code: "mn-ov", name: "Övörkhangai" },
          { code: "mn-se", name: "Selenge" },
          { code: "mn-su", name: "Sükhbaatar" },
          { code: "mn-to", name: "Töv" },
          { code: "mn-ub", name: "Ulaanbaatar" },
          { code: "mn-uv", name: "Uvs" },
          { code: "mn-za", name: "Zavkhan" },
        ],
      },
      ...
      // ── Pakistan (7 provinces & territories) ─────────────────────────────────
      {
        ...
        subRegions: [
          // Provinces
          { code: "pk-ba", name: "Balochistan",                 group: "Provinces" },
          { code: "pk-kb", name: "Khyber Pakhtunkhwa",          group: "Provinces" },
          { code: "pk-pb", name: "Punjab",                      group: "Provinces" },
          { code: "pk-sd", name: "Sindh",                       group: "Provinces" },
          // Territories
          { code: "pk-is", name: "Islamabad Capital Territory", group: "Territories" },
          { code: "pk-aj", name: "Azad Kashmir",                group: "Territories" },
      ...
      // ── Thailand (77 provinces) ──────────────────────────────────────────────
      {
        ...
        subRegions: [
          // Northern
          { code: "th-cm", name: "Chiang Mai",    group: "Northern" },
          { code: "th-cr", name: "Chiang Rai",    group: "Northern" },
          { code: "th-lg", name: "Lampang",       group: "Northern" },
          { code: "th-lp", name: "Lamphun",       group: "Northern" },
          { code: "th-ms", name: "Mae Hong Son",  group: "Northern" },
          { code: "th-nn", name: "Nan",           group: "Northern" },
          { code: "th-py", name: "Phayao",        group: "Northern" },
          { code: "th-pr", name: "Phrae",         group: "Northern" },
          { code: "th-ut", name: "Uttaradit",     group: "Northern" },
          // Northeastern
          { code: "th-ac", name: "Amnat Charoen", group: "Northeastern" },
          { code: "th-bk", name: "Bueng Kan",     group: "Northeastern" },
          { code: "th-br", name: "Buri Ram",      group: "Northeastern" },
          { code: "th-cp", name: "Chaiyaphum",    group: "Northeastern" },
          { code: "th-kn", name: "Kalasin",       group: "Northeastern" },
          { code: "th-ke", name: "Khon Kaen",     group: "Northeastern" },
          { code: "th-le", name: "Loei",          group: "Northeastern" },
          { code: "th-mk", name: "Maha Sarakham", group: "Northeastern" },
          { code: "th-md", name: "Mukdahan",      group: "Northeastern" },
          { code: "th-np", name: "Nakhon Phanom", group: "Northeastern" },
          { code: "th-nr", name: "Nakhon Ratchasima", group: "Northeastern" },
          { code: "th-nb", name: "Nong Bua Lam Phu", group: "Northeastern" },
          { code: "th-nk", name: "Nong Khai",    group: "Northeastern" },
          { code: "th-re", name: "Roi Et",        group: "Northeastern" },
          { code: "th-sn", name: "Sakon Nakhon", group: "Northeastern" },
          { code: "th-sk", name: "Si Sa Ket",     group: "Northeastern" },
          { code: "th-su", name: "Surin",         group: "Northeastern" },
          { code: "th-ub", name: "Ubon Ratchathani", group: "Northeastern" },
          { code: "th-ud", name: "Udon Thani",    group: "Northeastern" },
          { code: "th-ys", name: "Yasothon",      group: "Northeastern" },
          // Central
          { code: "th-an", name: "Ang Thong",     group: "Central" },
          { code: "th-ay", name: "Ayutthaya",     group: "Central" },
          { code: "th-bk2",name: "Bangkok",       group: "Central" },
          { code: "th-cn", name: "Chainat",       group: "Central" },
          { code: "th-lb", name: "Lop Buri",      group: "Central" },
          { code: "th-ny", name: "Nakhon Nayok",  group: "Central" },
          { code: "th-npm",name: "Nakhon Pathom", group: "Central" },
          { code: "th-nb2",name: "Nonthaburi",    group: "Central" },
          { code: "th-pt", name: "Pathum Thani",  group: "Central" },
          { code: "th-pb", name: "Phetchaburi",   group: "Central" },
          { code: "th-pkk",name: "Prachuap Khiri Khan", group: "Central" },
          { code: "th-rb", name: "Ratchaburi",    group: "Central" },
          { code: "th-sb", name: "Samut Prakan",  group: "Central" },
          { code: "th-sm", name: "Samut Sakhon",  group: "Central" },
          { code: "th-ss", name: "Samut Songkhram",group: "Central" },
          { code: "th-sr", name: "Sara Buri",     group: "Central" },
          { code: "th-sg", name: "Sing Buri",     group: "Central" },
          { code: "th-sp", name: "Suphan Buri",   group: "Central" },
          // Western
          { code: "th-kj", name: "Kanchanaburi",  group: "Western" },
          { code: "th-pk", name: "Phetchabun",    group: "Western" },
          { code: "th-pc", name: "Phichit",       group: "Western" },
          { code: "th-pl", name: "Phitsanulok",   group: "Western" },
          { code: "th-nw", name: "Nakhon Sawan",  group: "Western" },
          { code: "th-tk", name: "Tak",           group: "Western" },
          { code: "th-utn",name: "Uthai Thani",   group: "Western" },
          // Eastern
          { code: "th-cc", name: "Chachoengsao",  group: "Eastern" },
          { code: "th-ct", name: "Chanthaburi",   group: "Eastern" },
          { code: "th-cb", name: "Chon Buri",     group: "Eastern" },
          { code: "th-pi", name: "Prachin Buri",  group: "Eastern" },
          { code: "th-ry", name: "Rayong",        group: "Eastern" },
          { code: "th-sk2",name: "Sa Kaeo",       group: "Eastern" },
          { code: "th-tr", name: "Trat",          group: "Eastern" },
          // Southern
          { code: "th-ch", name: "Chumphon",      group: "Southern" },
          { code: "th-kb", name: "Krabi",         group: "Southern" },
          { code: "th-nst",name: "Nakhon Si Thammarat", group: "Southern" },
          { code: "th-nw2",name: "Narathiwat",    group: "Southern" },
          { code: "th-pn", name: "Pattani",       group: "Southern" },
          { code: "th-png",name: "Phangnga",      group: "Southern" },
          { code: "th-phg",name: "Phatthalung",   group: "Southern" },
          { code: "th-phu",name: "Phuket",        group: "Southern" },
          { code: "th-rn", name: "Ranong",        group: "Southern" },
          { code: "th-st", name: "Satun",         group: "Southern" },
          { code: "th-so", name: "Songkhla",      group: "Southern" },
          { code: "th-srth",name:"Surat Thani",   group: "Southern" },
          { code: "th-tg", name: "Trang",         group: "Southern" },
          { code: "th-yl", name: "Yala",          group: "Southern" },
        ],
      },
      ...
      // ── Uzbekistan (14 regions) ──────────────────────────────────────────────
      {
        ...
        subRegions: [
          ...
          { code: "uz-qr", name: "Karakalpakstan" },
