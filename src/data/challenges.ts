    ...
    countries: [
      ...
      // ── China (34 province-level divisions) ──────────────────────────────────
      {
        ...
        subRegions: [
          ...
          { code: "cn-hk",  name: "Hong Kong",      group: "Special Administrative Regions" },
          { code: "cn-mo",  name: "Macao",          group: "Special Administrative Regions" },
        ],
      },
      ...
      // ── Indonesia (38 provinces) ─────────────────────────────────────────────
      {
        ...
        subRegions: [
          // Sumatra
          { code: "id-ac", name: "Aceh",                    group: "Sumatra" },
          { code: "id-su", name: "North Sumatra",           group: "Sumatra" },
          { code: "id-sb", name: "West Sumatra",            group: "Sumatra" },
          { code: "id-ri", name: "Riau",                    group: "Sumatra" },
          { code: "id-ja", name: "Jambi",                   group: "Sumatra" },
          { code: "id-ss", name: "South Sumatra",           group: "Sumatra" },
          { code: "id-be", name: "Bengkulu",                group: "Sumatra" },
          { code: "id-la", name: "Lampung",                 group: "Sumatra" },
          { code: "id-bb", name: "Bangka Belitung Islands", group: "Sumatra" },
          { code: "id-kr", name: "Riau Islands",            group: "Sumatra" },
          // Java
          { code: "id-jk", name: "Jakarta",                 group: "Java" },
          { code: "id-jb", name: "West Java",               group: "Java" },
          { code: "id-bt", name: "Banten",                  group: "Java" },
          { code: "id-jt", name: "Central Java",            group: "Java" },
          { code: "id-yo", name: "Yogyakarta",              group: "Java" },
          { code: "id-ji", name: "East Java",               group: "Java" },
          // Bali & Nusa Tenggara
          { code: "id-ba", name: "Bali",                    group: "Bali & Nusa Tenggara" },
          { code: "id-nb", name: "West Nusa Tenggara",      group: "Bali & Nusa Tenggara" },
          { code: "id-nt", name: "East Nusa Tenggara",      group: "Bali & Nusa Tenggara" },
          // Kalimantan
          { code: "id-kb", name: "West Kalimantan",         group: "Kalimantan" },
          { code: "id-kt", name: "Central Kalimantan",      group: "Kalimantan" },
          { code: "id-ks", name: "South Kalimantan",        group: "Kalimantan" },
          { code: "id-ki", name: "East Kalimantan",         group: "Kalimantan" },
          { code: "id-ku", name: "North Kalimantan",        group: "Kalimantan" },
          // Sulawesi
          { code: "id-sa", name: "North Sulawesi",          group: "Sulawesi" },
          { code: "id-go", name: "Gorontalo",               group: "Sulawesi" },
          { code: "id-st", name: "Central Sulawesi",        group: "Sulawesi" },
          { code: "id-sr", name: "West Sulawesi",           group: "Sulawesi" },
          { code: "id-sn", name: "South Sulawesi",          group: "Sulawesi" },
          { code: "id-sg", name: "Southeast Sulawesi",      group: "Sulawesi" },
          // Maluku
          { code: "id-ma", name: "Maluku",                  group: "Maluku" },
          { code: "id-mu", name: "North Maluku",            group: "Maluku" },
          // Papua
          { code: "id-pa", name: "Papua",                   group: "Papua" },
          { code: "id-pb", name: "West Papua",              group: "Papua" },
      ...
      // ── Japan (47 prefectures) ───────────────────────────────────────────────
      {
        ...
        subRegions: [
          // Hokkaido
          { code: "jp-01", name: "Hokkaido",   group: "Hokkaido" },
          // Tohoku
          { code: "jp-02", name: "Aomori",     group: "Tohoku" },
          { code: "jp-03", name: "Iwate",      group: "Tohoku" },
          { code: "jp-04", name: "Miyagi",     group: "Tohoku" },
          { code: "jp-05", name: "Akita",      group: "Tohoku" },
          { code: "jp-06", name: "Yamagata",   group: "Tohoku" },
          { code: "jp-07", name: "Fukushima",  group: "Tohoku" },
          // Kanto
          { code: "jp-08", name: "Ibaraki",    group: "Kanto" },
          { code: "jp-09", name: "Tochigi",    group: "Kanto" },
          { code: "jp-10", name: "Gunma",      group: "Kanto" },
          { code: "jp-11", name: "Saitama",    group: "Kanto" },
          { code: "jp-12", name: "Chiba",      group: "Kanto" },
          { code: "jp-13", name: "Tokyo",      group: "Kanto" },
          { code: "jp-14", name: "Kanagawa",   group: "Kanto" },
          // Chubu
          { code: "jp-15", name: "Niigata",    group: "Chubu" },
          { code: "jp-16", name: "Toyama",     group: "Chubu" },
          { code: "jp-17", name: "Ishikawa",   group: "Chubu" },
          { code: "jp-18", name: "Fukui",      group: "Chubu" },
          { code: "jp-19", name: "Yamanashi",  group: "Chubu" },
          { code: "jp-20", name: "Nagano",     group: "Chubu" },
          { code: "jp-21", name: "Gifu",       group: "Chubu" },
          { code: "jp-22", name: "Shizuoka",   group: "Chubu" },
          { code: "jp-23", name: "Aichi",      group: "Chubu" },
          // Kansai
          { code: "jp-24", name: "Mie",        group: "Kansai" },
          { code: "jp-25", name: "Shiga",      group: "Kansai" },
          { code: "jp-26", name: "Kyoto",      group: "Kansai" },
          { code: "jp-27", name: "Osaka",      group: "Kansai" },
          { code: "jp-28", name: "Hyogo",      group: "Kansai" },
          { code: "jp-29", name: "Nara",       group: "Kansai" },
          { code: "jp-30", name: "Wakayama",   group: "Kansai" },
          // Chugoku
          { code: "jp-31", name: "Tottori",    group: "Chugoku" },
          { code: "jp-32", name: "Shimane",    group: "Chugoku" },
          { code: "jp-33", name: "Okayama",    group: "Chugoku" },
          { code: "jp-34", name: "Hiroshima",  group: "Chugoku" },
          { code: "jp-35", name: "Yamaguchi",  group: "Chugoku" },
          // Shikoku
          { code: "jp-36", name: "Tokushima",  group: "Shikoku" },
          { code: "jp-37", name: "Kagawa",     group: "Shikoku" },
          { code: "jp-38", name: "Ehime",      group: "Shikoku" },
          { code: "jp-39", name: "Kochi",      group: "Shikoku" },
          // Kyushu & Okinawa
          { code: "jp-40", name: "Fukuoka",    group: "Kyushu & Okinawa" },
          { code: "jp-41", name: "Saga",       group: "Kyushu & Okinawa" },
          { code: "jp-42", name: "Nagasaki",   group: "Kyushu & Okinawa" },
          { code: "jp-43", name: "Kumamoto",   group: "Kyushu & Okinawa" },
          { code: "jp-44", name: "Oita",       group: "Kyushu & Okinawa" },
          { code: "jp-45", name: "Miyazaki",   group: "Kyushu & Okinawa" },
          { code: "jp-46", name: "Kagoshima",  group: "Kyushu & Okinawa" },
          { code: "jp-47", name: "Okinawa",    group: "Kyushu & Okinawa" },
        ],
      },
      ...
      // ── Malaysia (16 states & federal territories) ───────────────────────────
      {
        ...
        subRegions: [
          // Peninsular Malaysia
          { code: "my-jh", name: "Johor",              group: "Peninsular Malaysia" },
          { code: "my-kd", name: "Kedah",              group: "Peninsular Malaysia" },
          { code: "my-kn", name: "Kelantan",           group: "Peninsular Malaysia" },
          { code: "my-me", name: "Melaka",             group: "Peninsular Malaysia" },
          { code: "my-ns", name: "Negeri Sembilan",    group: "Peninsular Malaysia" },
          { code: "my-ph", name: "Pahang",             group: "Peninsular Malaysia" },
          { code: "my-py", name: "Penang",             group: "Peninsular Malaysia" },
          { code: "my-pk", name: "Perak",              group: "Peninsular Malaysia" },
          { code: "my-pl", name: "Perlis",             group: "Peninsular Malaysia" },
          { code: "my-sb2",name: "Selangor",           group: "Peninsular Malaysia" },
          { code: "my-tr", name: "Terengganu",         group: "Peninsular Malaysia" },
          // East Malaysia
          { code: "my-sa", name: "Sabah",              group: "East Malaysia" },
          { code: "my-sw", name: "Sarawak",            group: "East Malaysia" },
          // Federal Territories
          { code: "my-kl", name: "Kuala Lumpur",       group: "Federal Territories" },
          { code: "my-lb", name: "Labuan",             group: "Federal Territories" },
          { code: "my-pu", name: "Putrajaya",          group: "Federal Territories" },
        ],
      },
      ...
      // ── Myanmar (15 states, regions & union territory) ────────────────────────
      {
        ...
        subRegions: [
          // States
          { code: "mm-ch", name: "Chin",          group: "States" },
          { code: "mm-ka", name: "Kachin",        group: "States" },
          { code: "mm-kah",name: "Kayah",         group: "States" },
          { code: "mm-kn", name: "Kayin",         group: "States" },
          { code: "mm-mo", name: "Mon",           group: "States" },
          { code: "mm-ra", name: "Rakhine",       group: "States" },
          { code: "mm-sh", name: "Shan",          group: "States" },
          // Regions
      ...
      // ── Philippines (17 regions) ─────────────────────────────────────────────
      {
        ...
        subRegions: [
          ...
          { code: "ph-bm",  name: "Bangsamoro (BARMM)",                         group: "Mindanao" },
        ],
      },
