...
export const HISTORY_NOTES: HistoryNote[] = [
  ...
  { country: "Iraq", era: "1921–1958 monarchy", status: "to-verify",
    candidate: "Flag_of_Iraq_(1924–1959).svg",
    detail: "IQ history jumps from the 1958 First Republic with no Kingdom of Iraq — the Hashemite monarchy (black-white-green with a red trapezoid and two stars). Couldn't verify the filename (Wikimedia rate-limited); confirm the preview loads, then promote into the Codex." },
  ...
  { country: "Syria", era: "2024 flag change — ACCURACY", status: "to-verify",
    candidate: "Flag_of_the_Syrian_Revolution.svg",
    detail: "IMPORTANT: After the fall of Assad (Dec 2024), Syria's transitional government adopted the green-white-black flag with three red stars (the former independence/opposition flag) as the official national flag. The app still shows the old red-white-black two-green-stars flag as current — in FLAGS, /flags/sy.svg AND the Codex. This needs a real decision: updating it changes Syria everywhere in the app, so confirm before I touch it." },
